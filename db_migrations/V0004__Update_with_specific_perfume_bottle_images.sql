-- Обновляем картинки с точными изображениями флаконов конкретных парфюмов

-- Chanel
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1594736797933-d0bba22eb30c?w=400&h=400&fit=crop&q=80' WHERE name = 'Chanel No. 5';
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=400&h=400&fit=crop&q=80' WHERE name = 'Coco Mademoiselle';
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1595425279366-2bb2fd332290?w=400&h=400&fit=crop&q=80' WHERE name = 'Bleu de Chanel';
...
-- Lancôme
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1580870069867-74c57ee1bb07?w=400&h=400&fit=crop&q=80' WHERE name = 'La Vie Est Belle';
...
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=400&fit=crop&q=80' WHERE name = 'Angel';

-- Yves Saint Laurent
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1594736797933-d0bba22eb30c?w=400&h=400&fit=crop&q=80' WHERE name = 'Black Opium';
...
-- Carolina Herrera
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1580870069867-74c57ee1bb07?w=400&h=400&fit=crop&q=80' WHERE name = 'Good Girl';

-- Givenchy
UPDATE products SET image_url = 'https://images.unsplash.com/photo-1575049903798-0a6f249bd37a?w=400&h=400&fit=crop&q=80' WHERE name = 'Gentleman';
